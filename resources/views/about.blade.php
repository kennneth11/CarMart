  ...
  <section class="about_us section-padding">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p>A one stop marketplace for car enthusiast in the province of Bukidnon. Where you can sell used and brand new cars, display all you want, and browse all you can.</p>
      </div>
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <div class="about_content row">
            ...
            <div class="col-md-7 col-sm-8 col-xs-8">
              ...
              <p>To provide an online marketplace for cars in the province of Bukidnon.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-sm-6">
          <div class="about_content row">
            ...
            <div class="col-md-7 col-sm-8 col-xs-8">
              ...
              <p>Uplift the quality of marketing through digital marketing.</p>
            </div>
          </div>
        </div>
      </div>
